...
class Game:
	...
	def initEntity(self):
		...
		self.minionList = [
			...
			CreateMinion('mage', self, 1088, 688, 3, FPS*60),
			...
			CreateMinion('mage', self, 2132, 766, 3, FPS*60),
			CreateMinion('mage', self, 2132, 862, 3, FPS*60),
   			CreateMinion('mage', self, 1664, 688, 5, FPS*60),
        ]
